...
class Unet(nn.Module):
    def __init__(self,c_in = 3) -> None:
        super().__init__()
        self.downblk = DownBlock(c_in,64,64)
...
class UnetConditional(nn.Module):
    def __init__(self,c_in = 3,num_classes = 10) -> None:
        super().__init__()
        self.downblk = DownBlock(c_in,64,32)
        self.downblk1 = DownBlock(64,128,16)
        self.downblk2 = DownBlock(128,256,8)
        self.midblk = MidBlock(256,512)
        self.midblk1 = MidBlock(512,512)
        self.midblk2 = MidBlock(512,256)
        self.upblk = UpBlock(256,128,8)
        self.upblk1 = UpBlock(128,64,16)
        self.upblk2 = UpBlock(64,32,32)
